...
import { listarTodos, listarLiberados, buscarPorId, responder, listarTodasTentativas } from '../controllers/quizController.js'
...
router.get('/tentativas/listarTodas', listarTodasTentativas) // GET http://localhost:5000/api/v1/quizzes/tentativas/listarTodas
